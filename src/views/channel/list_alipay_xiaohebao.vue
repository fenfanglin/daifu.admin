<template>
	<div class="app-container">
		...
		<el-table v-if="is_mobile == false" ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list" @selection-change="handleSelectionChange">
			...
			<el-table-column label="支付宝名称" prop="name" :show-overflow-tooltip="true" width="150" />
			<el-table-column label="支付宝账号" prop="account" />
			...
			<el-table-column label="最后在线时间" prop="last_online_time" min-width="60" />
			...
			<el-table-column label="操作" width="350" fixed="right">
				<template slot-scope="scope">
					...
					<el-button type="primary" class="tb-button" icon="el-icon-search" @click="handleViewApi(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:view_api']" plain>检测</el-button>
					<el-button type="primary" class="tb-button" icon="el-icon-setting" @click="handleEditInfo(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:save_info:edit']" plain>设置</el-button>
					<el-button type="success" class="tb-button" icon="el-icon-success
" @click="enable(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:enable']" plain>开启</el-button>
					<el-button type="danger" class="tb-button" icon="el-icon-error" @click="disable(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:disable']" plain>关闭</el-button>
		...
		<el-table v-else ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list" @selection-change="handleSelectionChange">
			...
			<el-table-column label="商户名称" prop="business_username" :show-overflow-tooltip="true" width="120" />
			<el-table-column label="支付宝名称" prop="name" :show-overflow-tooltip="true" width="150" />
			<el-table-column label="支付宝账号" prop="account" width="220" />
			<el-table-column label="单笔控制" width="180">
				<template slot-scope="scope">
					<span>{{scope.row.min_amount}} - {{scope.row.max_amount}}</span>
				</template>
			...
			<el-table-column label="操作" width="350">
				<template slot-scope="scope">
					<el-button type="primary" class="tb-button" icon="el-icon-edit" @click="handleEdit(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:save:edit']" plain>11编辑</el-button>
					<el-button type="primary" class="tb-button" icon="el-icon-search" @click="handleViewApi(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:view_api']" plain>检测</el-button>
					<el-button type="primary" class="tb-button" icon="el-icon-setting" @click="handleEditInfo(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:save_info:edit']" plain>设置</el-button>
					<el-button type="success" class="tb-button" icon="el-icon-success
" @click="enable(scope.row)" v-hasPermi="['channel_alipay_xiaohebao:enable']" plain>开启</el-button>
