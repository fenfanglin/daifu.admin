<template>
	<div class="app-container">
		...
		<el-table v-if="is_mobile == false" ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list" @selection-change="handleSelectionChange">
			...
			<el-table-column label="云闪付账号" prop="other_info" :show-overflow-tooltip="true" width="150" />
...
" @click="enable(scope.row)" v-hasPermi="['channel_yunshanfu:enable']" plain>开启</el-button>
					<el-button type="danger" class="tb-button" icon="el-icon-error" @click="disable(scope.row)" v-hasPermi="['channel_yunshanfu:disable']" plain>关闭</el-button>
