...
" @click="enable(scope.row)" v-hasPermi="['channel_web_bank:enable']" plain>开启</el-button>
					<el-button type="danger" class="tb-button" icon="el-icon-error" @click="disable(scope.row)" v-hasPermi="['channel_web_bank:disable']" plain>关闭</el-button>
