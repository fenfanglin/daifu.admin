<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb20">
			...
			<el-col :span="1.5">
				<el-button type="danger" icon="el-icon-delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['business:delete']">删除</el-button>
			</el-col>
			<el-col :span="1.5">
		...
		<el-table v-if="is_mobile == false" ref="multipleTable" v-loading="loading" border empty-text="没有相关数据" :data="list">
			...
			<el-table-column label="操作" width="500">
				<template slot-scope="scope">
					<el-button type="primary" class="tb-button" icon="el-icon-edit" @click="edit(scope.row)" v-hasPermi="['business:save:edit']" plain>编辑</el-button>
					<el-button type="primary" class="tb-button" icon="el-icon-s-tools" @click="editChannel(scope.row)" v-hasPermi="['business:save_channel']" plain>通道</el-button>
					<el-button type="primary" class="tb-button" icon="el-icon-s-finance" @click="editRecharge(scope.row)" v-hasPermi="['business:save_recharge']" plain>充值</el-button>
					<!-- <el-button type="primary" class="tb-button" icon="el-icon-user-solid" @click="login(scope.row)" v-hasPermi="['business:login']" plain>登录</el-button> -->
					<el-button type="primary" class="tb-button" icon="el-icon-lock" @click="editPassword(scope.row)" v-hasPermi="['business:change_password']" plain>密码</el-button>
					<el-button type="success" class="tb-button" icon="el-icon-success
" @click="enable(scope.row)" v-hasPermi="['business:enable']" plain>启用</el-button>
					<el-button type="danger" class="tb-button" icon="el-icon-error" @click="disable(scope.row)" v-hasPermi="['business:disable']" plain>禁用</el-button>
...
<script>
export default {
	name: "business_list_business", // 路由上 '/' 换成 '_'
	data() {
		return {
			user: this.getUser(),
